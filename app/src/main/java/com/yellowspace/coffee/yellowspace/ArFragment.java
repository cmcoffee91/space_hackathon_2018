...
public class ArFragment extends Fragment {
    ...
    private ARAdapter mVideoAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        feedList.add("astronaut");
        feedList.add("spaceship");
        feedList.add("saucer");
        feedList.add("comet");
        feedList.add("rover");
        feedList.add("sun");
        ...
        mVideoRecyclerView = (RecyclerView) v.findViewById(R.id.ar_recycler_view);
        mVideoRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        mVideoAdapter = new ARAdapter(feedList, getActivity());
